...
{
    private const string MetricAttributeName = "Moongate.Server.Data.Metrics.Attributes.MetricAttribute";
    private const string MetricValueTransformTypeName = "Moongate.Server.Data.Metrics.Types.MetricValueTransformType";
    ...
    private static string BuildSource(IReadOnlyList<MetricSnapshotModel> snapshots)
    {
        ...
        sb.AppendLine("using Moongate.Server.Data.Metrics.Types;");
        sb.AppendLine();
        sb.AppendLine("namespace Moongate.Server.Data.Metrics;");
        sb.AppendLine();
