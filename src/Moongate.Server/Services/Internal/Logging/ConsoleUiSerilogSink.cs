...
namespace Moongate.Server.Services.Internal.Logging;
...
public sealed class ConsoleUiSerilogSink : ILogEventSink
{
    ...
    public void Emit(LogEvent logEvent)
    {
        ...
        _consoleUiService.WriteLogLine(
            writer.ToString(),
            logEvent.Level,
            GetHighlightedValues(logEvent.Properties.Values)
        );
    }

    private static HashSet<string> GetHighlightedValues(IEnumerable<LogEventPropertyValue> values)
    {
