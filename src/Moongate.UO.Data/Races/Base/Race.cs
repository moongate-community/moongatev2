...
public abstract class Race : ISpanParsable<Race>
{
    ...
    //public UOExpansion RequiredExpansion { get; }
    ...
    public virtual int AliveBody(UOMobileEntity m)
        => AliveBody(m.Gender == GenderType.Female);

    public virtual int AliveBody(bool female)
        => female ? FemaleBody : MaleBody;

    public virtual int Body(UOMobileEntity m)
        => m.IsAlive ? AliveBody(m.Gender == GenderType.Female) : GhostBody(m.Gender == GenderType.Female);
    ...
    public virtual int GhostBody(UOMobileEntity m)
        => GhostBody(m.Gender == GenderType.Female);
